# -*- coding: utf-8 -*-
"""
Created on Wed Jul 11 14:57:01 2018
...
while(True):
    ...
    if cv2.waitKey(1) & 0xFF == ord('q'):
        out=cv2.imwrite("C:\\Users\\DEEPIKA JOSHI\\Desktop\\FINAL PROJECT\\DATASET AND CODE\\flowers.jpg",frame)
        break
cap.release()
...
import numpy as np
test_set = image.load_img("C:\\Users\\DEEPIKA JOSHI\\Desktop\\FINAL PROJECT\\DATASET AND CODE\\flowers.jpg",target_size=(56,56))
